...
**Последнее обновление индекса:** 2026-09-24 (AI-CODING-GUIDELINES added)
...
|------|--------------|----------------------|---------------|--------------|
| **Bootstrap / новая сессия** | Любая незнакомая задача | [PROJECT-CONTEXT.md](./PROJECT-CONTEXT.md) | [AI-CODING-GUIDELINES.md](./AI-CODING-GUIDELINES.md) · [docs/README.md](../README.md) | — |
...
| **Документация (meta)** | структура, roadmap, guidelines, **ревью docs** | [docs-guidelines.md](../13-maintenance/docs-guidelines.md) → [docs-review.md](../13-maintenance/docs-review.md) → [DOCS-ROADMAP.md](./DOCS-ROADMAP.md) | [DOCS-REVIEW-LOG.md](./DOCS-REVIEW-LOG.md) · [ops-hygiene.md](../13-maintenance/ops-hygiene.md) · [docs/README.md](../README.md) | процесс ревью **0.3** ✅ · status vocab · cron + session checklist |
