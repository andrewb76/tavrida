...
bff, billing, plan-config, auction, subscriptions, rating, deal-feedback, forum, user-profile, scalar-config, notifications, **webhooks**, marketplace — см. [каталог](../05-microservices/README.md).
...
| **admin-ui** | Реализованы users, roles, plan/scalar config, periods, Vanga; общий spec ещё нужен |
...
| **Код vs docs** | 12 PostgreSQL services реализованы с разной глубиной; rating/webhooks/referral-rewards остаются docs-only |
