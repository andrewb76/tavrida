...
bff, billing, plan-config, auction, subscriptions, rating, deal-feedback, forum, user-profile, settings, notifications, **webhooks**, marketplace — см. [каталог](../05-microservices/README.md).
