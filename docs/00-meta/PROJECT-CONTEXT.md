...
| **Фаза** | Docs v0.2 ✅ · UX + Frontend spec ✅ · **Scaffold+** (BFF, forum, marketplace, subscriptions, notifications, …) · Frontend SPA |
...
**Код (pnpm workspace):** `bff`, `billing`, `plan-config`, `auction`, `subscriptions`, `forum`, `user-profile`, `scalar-config`, `notifications`, `marketplace`, `deal-feedback`, `periods`, `chat`  
**Только docs (нет `package.json`):** `rating`, `webhooks`  
**Порты:** bff 3000 · billing 3001 · plan-config 3002 · auction 3003 · subscriptions 3004 · deal-feedback 3006 · user-profile 3007 · scalar-config 3008 · forum 3009 · notifications 3010 · marketplace **3011** · referral-rewards 3012 (draft) · vanga 3013 (draft) · periods 3014 · webhooks **3015** (draft) · chat **3016**
...
**v0.2** · последнее обновление: 2026-07-23 (docs-review P0–P1: rating SoT, chat port, hard-lock×Act-As)
