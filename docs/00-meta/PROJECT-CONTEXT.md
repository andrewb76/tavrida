...
| 011 | **Исходящие webhooks** — централизованный `webhooks` — [ADR-011](../03-architecture/adr/011-centralized-outbound-webhooks.md) |
...
| Frontend SPA | [14-frontend/README.md](../14-frontend/README.md) |

## Сервисы

**Код (каркас):** `billing`, `financial-policy`, `auction`, `auction-subscriptions` (→ `subscriptions`)  
**Только docs:** `bff`, `rating`, `deal-feedback`, `forum`, `user-profile`, `settings`, `notifications`, `webhooks`, `marketplace`  
**Порты (draft):** billing 3001, financial-policy 3002, notifications 3010, webhooks 3011, bff 3000
...
1. ✅ Фундамент 2. ✅ Core 3. ✅ Domain 4. ✅ Ops 5. ✅ UX 6. ✅ Frontend spec · ⏳ impl
