...
**Код (pnpm workspace):** `bff`, `billing`, `plan-config`, `auction`, `subscriptions`, `forum`, `user-profile`, `scalar-config`, `notifications`, `marketplace`, `deal-feedback`, `periods`  
...
**v0.2** · последнее обновление: 2026-07-16
