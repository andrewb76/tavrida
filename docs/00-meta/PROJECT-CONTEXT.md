...
| 013 | **referral-rewards** — денежные бонусы (rules settings + FP) — [ADR-013](../03-architecture/adr/013-referral-rewards-service.md) |
...
**v0.2** · последнее обновление: 2026-07-09
