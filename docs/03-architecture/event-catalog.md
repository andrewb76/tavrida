...
См. [forum/tags.md](../05-microservices/forum/tags.md) · [subscriptions](../05-microservices/subscriptions/README.md).
...
| Event | auction | billing | plan-config | feedback | rating | notifications | webhooks | BFF/WS | marketplace | forum |
|-------|---------|---------|------------------|----------|--------|---------------|----------|--------|-------------|-------|
| auction.completed | — | | | ✅ | ✅ | ✅ | ✅ | | | |
