...
│    ├── О клубе (/about)
│    │     Позиционирование, как попасть.                                      📐 W12
│    ├── Политика cookie (/cookies)
│    │     L-07 · категории · изменить согласие.                               ✅
│    ├── Баннер cookie (overlay, App)
...
│
├─── 🚫 Hard lock (JWT-актор заблокирован)
│    └── Аккаунт заблокирован (/account-locked)
│          Сообщение + иллюстрация; ловушка маршрутов; выход вручную.         ✅
│
...
│
├─── 🗣️ Форум
│    ├── Главная форума — дерево (/forum)
│    ├── Список тем (/forum/topics)
...
| Лендинг | `/` | 📐 W01 | ✅ |
| О клубе | `/about` | 📐 W12 | ✅ |
| Политика cookie | `/cookies` | L-07 | ✅ |
| Баннер cookie | overlay | L-07 | ✅ |
| Инвайт | `/invite` | 📐 W11 | ✅ |
| OAuth callback | `/callback` | ⬜ | ✅ |
| Home member | `/` | 📐 W01 | ✅ |
| Inbox | overlay | 📐 W15 | ✅ |
...
| Главная форума (дерево) | `/forum` | 📐 W05a | ✅ |
| Список тем | `/forum/topics` | 📐 W05b | ✅ |
