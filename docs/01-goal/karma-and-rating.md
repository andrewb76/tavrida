...
|----|----------|----------|
| 1 | За активность | Высокая активность на форуме |
| 2 | За полезность | Полезные комментарии и помощь |
| 3 | За стаж | Длительное участие в клубе |
| 4 | За культуру | Соблюдение правил и этикета |
| 5 | За находчивость | Интересные темы и обсуждения |
| 6 | За щедрость | Помощь другим участникам |
| 7 | За мастерство | Экспертные знания в области |
...
- В профиле: полный список медалей (иконки + названия)
- В теме: медали автора (до 3 штук)
- В комментарии: медали автора (до 2 штук)
- При наведении на иконку — всплывающая подсказка с названием
