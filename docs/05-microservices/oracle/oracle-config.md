# ⚙️ Oracle — конфиг и UX параметров

> **Статус:** draft · **Версия:** 0.1  
> **Файл defaults:** [`config/oracle.defaults.yaml`](../../../config/oracle.defaults.yaml)  
...
Путь: **`config/oracle.defaults.yaml`**
...
- [ ] Промоция YAML → `oracle.*` settings после совещания
