...
**GMV** — сколько денег **перешло между участниками** при продаже лота. Платформа **не забирает** этот оборот (по текущей модели). В Oracle — **справочный** слайдер: «ожидаем 15 сделок по 5000₽».
