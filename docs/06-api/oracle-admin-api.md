...
> **Статус:** draft · **Auth:** JWT + Keto `admin` · **BFF:** `services/bff/src/modules/oracle/`
...
|--------|------|----------|
| `GET` | `/api/v1/admin/oracle/defaults` | YAML defaults + overlay |
| `POST` | `/api/v1/admin/oracle/simulate` | Прогноз на N месяцев |
| `POST` | `/api/v1/admin/oracle/compare` | До 3 сценариев |
...
```json
{
  "version": "0.1",
  "currency": "RUB",
  "config": { "...": "полный oracle.defaults.yaml" },
  "overlay": {
