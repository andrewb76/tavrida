...
var redis_pubsub_service_1 = require("./redis-pubsub.service");
var RedisModule = function () {
    var _classDecorators = [(0, common_1.Global)(), (0, common_1.Module)({
            providers: [redis_pubsub_service_1.RedisPubSubService],
            exports: [redis_pubsub_service_1.RedisPubSubService],
        })];
