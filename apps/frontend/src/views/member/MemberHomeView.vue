...
<template>
  <section class="space-y-8">
    ...
    <div>
      <h2 class="mb-3 text-lg font-medium">🔴 Live now</h2>
      <ul class="grid gap-3 sm:grid-cols-2">
        ...
        >
          ...
          <p class="mt-1 text-sm text-text-muted">{{ lot.currentPrice }} ₽</p>
        </li>
      </ul>
    </div>

    <div>
      <h2 class="mb-3 text-lg font-medium">Новые на форуме</h2>
      <ul class="space-y-2">
        <li v-for="topic in mockForumTopics" :key="topic.id">
          <RouterLink
