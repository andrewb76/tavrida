...
import VangaRangeField from '@/components/vanga/VangaRangeField.vue';
import VangaResultsPanel from '@/components/vanga/VangaResultsPanel.vue';
import { useVangaForecast } from '@/composables/useVangaForecast';
import { formatRub } from '@/utils/vangaDefaults';
import { costLabelRu, oneTimeLabelRu } from '@/utils/vangaLabels';
import {
  REFERRAL_MODEL_FIELDS,
  readReferralModelSpec,
  referralModelLabel,
  type ReferralModelId,
} from '@/utils/vangaReferralModels';
