...
export class AuctionsController {
  ...
  async createEnglish(
    @Body() dto: CreateEnglishAuctionDto,
    @CurrentUser() user: User
  ) {
    return await this.auctionsService.createEnglishAuction(dto, user.logtoId);
  }
  ...
  async createDutch(
    @Body() dto: CreateDutchAuctionDto,
    @CurrentUser() user: User
  ) {
    return await this.auctionsService.createDutchAuction(dto, user.logtoId);
  }
}
